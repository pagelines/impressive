	...
	function the_quotes(){
		...
		if( empty($out) ){
			$out[] = array(
				...
				'quoteauthorlink'	=> 'http://jamesgiroux.co', 
			...
			$out[] = array(
				'quote'	=> 'Impressive is the most comprehensive Landing Page WordPress Theme <br />that we\'ve ever built. Yes it\'s that good!', 
				'quoteauthorlink'	=> 'http://jamesgiroux.co', 
				'quoteauthor'	=>	'James Giroux'
			);
		}
